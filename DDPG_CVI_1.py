...
class ActorNetwork(object):
    ...
    between -2 and 2
    """
    def __init__(self, sess, state_dim, action_dim, action_bound, learning_rate, tau, beta = 0.1,
        ...
        # self.optimize = tf.train.AdagradOptimizer(learning_rate=0.01, initial_accumulator_value=1e-8).\
    ...
    def cvi_update_mean(self, grad, var, sigma):
        ...
        update_mean = [var[i].assign(var[i] - self.learning_rate * self.beta * natural_grads[i]) for i in range(len(var))]
...
def train(sess, env, actor, critic):
    ...
    for i in range(MAX_EPISODES):
        ...
        if i % 100 ==0:
            ...
            plt.xlabel('Episode')
            plt.ylabel('Rewards')
            savepath = '/Users/liuzuozhu/MyGit/Parameter_CVI/cvi/adagrad_test_0.png'
